  ...
  def smallBenchmark(): Unit = {
    ...
    def getWriteTime(collection: Seq[Int]): Double = {
      ...
      val times = for {
        ...
        val updatedCollection = collection.updated(index, elem)
