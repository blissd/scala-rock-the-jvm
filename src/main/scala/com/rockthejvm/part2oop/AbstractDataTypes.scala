...
object AbstractDataTypes {
  ...
  abstract class Animal {
    ...
    def preferredMeal: String = "anything" // "accessor methods" - no parens ()
  }
  ...
  class Dog extends Animal {
    ...
    override val preferredMeal: String = "bones" // override accessor method with a field
  }
  ...
  class TRex extends Carnivore {
    override def eat(animal: Animal): Unit = println("I'm a T-Rex and I eat animals")
  }

  // practical difference abstract classes vs traits
  // onc class inheritance
  ...
  /*
   philosopical difference abstract classes vs traits
  ...
  Any
   AnyRef
    All classes we write extend AnyRef
